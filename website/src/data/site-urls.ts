...
export const BOHR_GITHUB_REPO_URL = trimTrailingSlash(
  env.PUBLIC_BOHR_GITHUB_REPO_URL || "https://github.com/Dhruvil7694/BohrAI",
)
 ...
 */
export const BOHR_SITE_URL = trimTrailingSlash(env.PUBLIC_BOHR_SITE_URL || "https://bohr.local")
 ...
 */
export const BOHR_INSTALL_BASE_URL = trimTrailingSlash(env.PUBLIC_BOHR_INSTALL_BASE_URL || BOHR_GITHUB_RAW_BASE_URL)
